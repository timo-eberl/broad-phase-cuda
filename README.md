...
The benchmark suite is hosted in the [Tics physics engine](https://github.com/timo-eberl/tics) repository. To reproduce the setup used for the paper, use the commit `dfc1fe2a06f52aee287ad28b794431eb238cc88b`.
